...
import { MixedRouteTrade, MixedRouteSDK, Trade as RouterTrade } from 'smartswap-router-sdk'
import { Trade as V2Trade, Pair, Route as RouteV2, computePairAddress } from 'smartswap-v2-sdk'
import {
  Trade as V3Trade,
  Pool,
  Route as RouteV3,
...
import { CurrencyAmount, TradeType, Ether, Token, Percent, Currency } from 'smartswap-sdk-core'
import IUniswapV3Pool from 'smartswap-v3-core/artifacts/contracts/UniswapV3Pool.sol/UniswapV3Pool.json'
